...
-- Create settings table for token ratio and other settings
...
-- Insert default token ratio
INSERT INTO public.settings (key, value)
VALUES ('token_ratio', '100')
...
CREATE TRIGGER update_cashout_settings_updated_at
    BEFORE UPDATE ON public.cashout_settings
    FOR EACH ROW
    EXECUTE FUNCTION public.update_updated_at_column();
